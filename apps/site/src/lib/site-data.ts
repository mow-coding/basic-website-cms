...
export const workshops: Array<{
...
}> = [
  {
    ...
    introParagraphs: [
      [
        "프로그램 A는 임상 현장에 처음 발을 들이는 분들을 위한 입문 과정입니다.",
        "심리평가와 상담의 기본 개념을 이론 강의로 익히고, 간단한 사례로 실제 흐름을 경험합니다.",
      ],
      [
        "매 회차는 강의와 토론, 실습으로 구성되어 배운 내용을 바로 적용해 볼 수 있습니다.",
        "관련 전공생과 초심 실무자 모두에게 열려 있습니다.",
      ],
    ],
    status: "신청 중",
    courses: [],
  },
  {
    ...
    introParagraphs: [
      [
        "프로그램 B는 특정 주제를 짧고 깊게 다루는 단기 특강입니다.",
        "바쁜 일정 속에서도 핵심을 놓치지 않도록 하루나 이틀 과정으로 구성됩니다.",
      ],
      [
        "이론 요약과 사례 중심의 논의를 함께 진행하여,",
        "짧은 시간 안에 실질적인 도움을 얻어 가실 수 있습니다.",
      ],
    ],
    status: "신청 중",
    courses: [],
  },
  {
    ...
    introParagraphs: [
      [
        "프로그램 C는 여러 단계로 진행되는 심화 과정입니다.",
        "단계마다 이론을 다지고 사례 실습을 반복하며 참여자들이 서로의 시선을 나눕니다.",
      ],
      [
        "단계가 올라갈수록 다루는 사례의 난이도가 높아지며,",
        "전 과정을 이수하면 실무에 필요한 흐름을 체계적으로 익히게 됩니다.",
      ],
    ],
    status: "신청 중",
    courses: [],
  },
  {
    ...
    introParagraphs: [
      [
        "프로그램 D는 실제 사례를 깊이 있게 검토하는 고급 과정입니다.",
        "이미 실무 경험이 있는 분들이 자신의 사례를 가지고 와 함께 논의합니다.",
      ],
      [
        "소수 인원으로 진행되며,",
        "슈퍼비전과 토론을 통해 각자의 관점을 정교하게 다듬어 갑니다.",
      ],
    ],
    status: "신청 중",
    courses: [],
