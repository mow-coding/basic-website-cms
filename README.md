...
3. AI가 내 컴퓨터에 필요한 도구가 설치되어 있는지 확인하게 합니다.
4. AI 안내에 따라 GitHub, Vercel, Neon에 로그인합니다.
5. Google OAuth는 사용자가 Google Cloud Console에서 직접 만들고, AI가 옆에서 안내합니다.
6. 로컬에서 공개 사이트와 관리자 콘솔을 실행합니다.
7. Vercel에 두 앱을 배포합니다.
8. 먼저 안전한 문구, 이미지, 색상, 메뉴, 샘플 데이터부터 커스터마이즈합니다.
